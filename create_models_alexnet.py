...
def choose_hyperparameters_from_file(hyperparameter_ranges_file):
    ...
    # Inputs and outputs
    input_height = ranges['input_height']
    input_width = ranges['input_width']
    input_num_channels = ranges['input_num_channels']
    ...
    conv1_stride_height_range = ranges['conv1_stride_height']
    conv1_stride_width_range = ranges['conv1_stride_width']

    conv2_kernel_size_range = list(range(*ranges['conv2_kernel_size']))
    conv2_stride_height_range = ranges['conv2_stride_height']
    conv2_stride_width_range = ranges['conv2_stride_width']
    ...
    for conv1_kernel_width in conv1_kernel_width_range:
        for conv1_stride in conv1_stride_width_range:
            conv1_pad_width = 0
            conv1_pad_height = 1
                    ...
                    for conv2_kernel_size in conv2_kernel_size_range:
                        for conv2_stride in conv2_stride_range:
                            ...
                            conv2_output_width, conv2_output_height, conv2_output_depth = get_conv_output_dims(
                                ...
                                (conv2_padding_width, conv2_padding_height),
    ...
    hyperparameters = {
        'input_channel': input_num_channels,
